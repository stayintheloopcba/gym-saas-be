...
export const ACTIVE_ORG_SECURITY = 'active-organization';

export function buildOpenApiConfig() {
  return new DocumentBuilder()
    .setTitle('Generic SaaS API')
    .setDescription('Reusable multi-organization SaaS backend API.')
    .setVersion('1.0')
    ...
    .addCookieAuth('active_org', { type: 'apiKey', in: 'cookie' }, ACTIVE_ORG_SECURITY)
    .build();
}
